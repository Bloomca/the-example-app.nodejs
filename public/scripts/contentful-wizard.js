(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CTFLWizard"] = factory();
	else
		root["CTFLWizard"] = factory();
...
var animate_1 = __webpack_require__(27);
exports.animate = animate_1.animate;
var dom_1 = __webpack_require__(58);
exports.applyStyle = dom_1.applyStyle;
exports.containsNode = dom_1.containsNode;
exports.createElement = dom_1.createElement;
exports.isBrowser = dom_1.isBrowser;
exports.measureHeight = dom_1.measureHeight;
exports.renderOverlay = dom_1.renderOverlay;
var events_1 = __webpack_require__(59);
exports.onHover = events_1.onHover;
var links_1 = __webpack_require__(60);
exports.constructAssetURL = links_1.constructAssetURL;
exports.constructContentTypeURL = links_1.constructContentTypeURL;
exports.constructEntryURL = links_1.constructEntryURL;
exports.constructSpaceURL = links_1.constructSpaceURL;
exports.getEntryTitle = links_1.getEntryTitle;
var style_1 = __webpack_require__(61);
exports.mergeStyle = style_1.mergeStyle;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist_es_modules_create_http_client__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dist_es_modules_create_request_config__ = __webpack_require__(164);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dist_es_modules_enforce_obj_path__ = __webpack_require__(165);
/* unused harmony reexport enforceObjPath */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dist_es_modules_freeze_sys__ = __webpack_require__(166);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dist_es_modules_get_user_agent__ = __webpack_require__(168);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__dist_es_modules_to_plain_object__ = __webpack_require__(170);
...
Object.defineProperty(exports, "__esModule", { value: true });
var contentTypeNodes = {};
var entryNodes = {};
var assetNodes = {};
var styles = {};
function setStyle(_a) {
    var spaceId = _a.spaceId, style = _a.style;
    styles[spaceId] = style;
}
exports.setStyle = setStyle;
function getStyle(_a) {
    var spaceId = _a.spaceId;
    return styles[spaceId];
}
exports.getStyle = getStyle;
function getAssetsNodes() {
    return assetNodes;
}
exports.getAssetsNodes = getAssetsNodes;
function getAssetNodes(_a) {
    var asset = _a.asset;
    return assetNodes[asset] || [];
}
exports.getAssetNodes = getAssetNodes;
function removeAssetNode(_a) {
    var asset = _a.asset, node = _a.node;
    if (assetNodes[asset]) {
        assetNodes[asset] = assetNodes[asset].filter(function (assetNode) { return assetNode !== node; });
    }
    return assetNodes;
}
exports.removeAssetNode = removeAssetNode;
function setAssetNode(_a) {
    var asset = _a.asset, node = _a.node;
    if (!assetNodes[asset]) {
        assetNodes[asset] = [];
    }
...
exports.setAssetNode = setAssetNode;
function getContentTypeNodes() {
    return contentTypeNodes;
}
exports.getContentTypeNodes = getContentTypeNodes;
function getContentTypeNode(_a) {
    var contentType = _a.contentType;
    return contentTypeNodes[contentType] || [];
}
exports.getContentTypeNode = getContentTypeNode;
function setContentTypeNode(_a) {
    var contentType = _a.contentType, node = _a.node;
...
exports.setContentTypeNode = setContentTypeNode;
function removeContentTypeNode(_a) {
    var contentType = _a.contentType, removeNode = _a.node;
    if (contentTypeNodes[contentType]) {
        contentTypeNodes[contentType] = contentTypeNodes[contentType].filter(function (node) { return node !== removeNode; });
    }
    return contentTypeNodes;
}
exports.removeContentTypeNode = removeContentTypeNode;
function getCTEntryNodes(_a) {
    var contentType = _a.contentType;
    return entryNodes[contentType] || [];
}
exports.getCTEntryNodes = getCTEntryNodes;
function getEntryNodes(_a) {
    var contentType = _a.contentType, entry = _a.entry;
    if (entryNodes[contentType] && entryNodes[contentType][entry]) {
        return entryNodes[contentType][entry];
    }
    return [];
}
exports.getEntryNodes = getEntryNodes;
function setEntryNode(_a) {
    var contentType = _a.contentType, entry = _a.entry, node = _a.node;
...
exports.setEntryNode = setEntryNode;
function removeEntryNode(_a) {
    var contentType = _a.contentType, entryNode = _a.node, entry = _a.entry;
    if (entryNodes[contentType] && entryNodes[contentType][entry]) {
        entryNodes[contentType][entry] = entryNodes[contentType][entry].filter(function (node) { return node !== entryNode; });
    }
    return entryNodes;
}
exports.removeEntryNode = removeEntryNode;
...
Object.defineProperty(exports, "__esModule", { value: true });
var popup_1 = __webpack_require__(57);
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
function attach(_a) {
    var node = _a.node, contentType = _a.contentType, entry = _a.entry, spaceId = _a.spaceId, entryTitle = _a.entryTitle, description = _a.description, _b = _a.style, rawStyle = _b === void 0 ? state_1.getStyle({ spaceId: spaceId }) : _b, asset = _a.asset;
    if (!utils_1.isBrowser()) {
        // tslint:disable-next-line no-empty
        return function () { };
    }
    if (contentType) {
        state_1.setContentTypeNode({ contentType: contentType, node: node });
    }
    if (contentType && entry) {
        state_1.setEntryNode({
    ...
    if (asset) {
        state_1.setAssetNode({
            asset: asset,
            node: node
        });
    }
    var style = rawStyle === state_1.getStyle({ spaceId: spaceId }) ? rawStyle : utils_1.mergeStyle(rawStyle);
    var destroyPopup;
    var popupNode;
    utils_1.applyStyle({
        node: node,
    ...
    var cleanHover = utils_1.onHover({
        node: node,
    ...
    function onMouseEnter() {
        ...
        var popupData = popup_1.showPopup({
            node: node,
            spaceId: spaceId,
            entry: entry,
            contentType: contentType,
    ...
    function onMouseLeave(e) {
        var checkingNode = e.relatedTarget;
        if (!utils_1.containsNode({ node: popupNode, checkingNode: checkingNode })) {
            internalMouseLeave();
        }
    }
    return cleanup;
    ...
    function cleanup() {
        if (contentType) {
            state_1.removeContentTypeNode({ contentType: contentType, node: node });
        }
        if (contentType && entry) {
            state_1.removeEntryNode({ contentType: contentType, node: node, entry: entry });
        }
        if (asset) {
            state_1.removeAssetNode({ asset: asset, node: node });
        }
        destroyPopup && destroyPopup();
...
function animate(_a) {
    var _this = this;
    var node = _a.node, _b = _a.time, time = _b === void 0 ? 200 : _b, start = _a.start, stop = _a.stop, _c = _a.property, property = _c === void 0 ? "opacity" : _c;
    // no need to re-render more often than 16ms – 1 frame
    var steps = Math.ceil(time / 16);
    return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
        var period, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    period = (stop - start) / steps;
                    i = 1;
                    _a.label = 1;
                case 1:
                    if (!(i <= steps)) return [3 /*break*/, 4];
                    node.style[property] = String(start + period * i);
                    return [4 /*yield*/, sleep(time / steps)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
...
Object.defineProperty(exports, "__esModule", { value: true });
var contentful_1 = __webpack_require__(64);
var attach_1 = __webpack_require__(26);
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
exports.clients = {};
function init(_a) {
    var key = _a.key, spaceId = _a.spaceId, preview = _a.preview, entryTitle = _a.entryTitle, style = _a.style;
    if (!utils_1.isBrowser()) {
        return {
            // tslint:disable-next-line no-empty
            update: function () { },
    ...
    exports.clients[spaceId] = contentful_1.createClient({
    ...
    var mergedStyle = utils_1.mergeStyle(style);
    state_1.setStyle({ spaceId: spaceId, style: mergedStyle });
    var cleanup = attachHandlers({
        spaceId: spaceId,
        entryTitle: entryTitle,
        style: mergedStyle
    });
    return {
        ...
        update: function () {
            cleanup && cleanup();
            cleanup = attachHandlers({ spaceId: spaceId, entryTitle: entryTitle, style: mergedStyle });
        },
        destroy: function () {
            cleanup && cleanup();
            cleanup = null;
...
exports.init = init;
function attachHandlers(_a) {
    var spaceId = _a.spaceId, entryTitle = _a.entryTitle, style = _a.style;
    var entryElements = document.querySelectorAll("[data-ctfl-entry]");
    var assetElements = document.querySelectorAll("[data-ctfl-asset]");
    var allElements = Array.from(entryElements).concat(Array.from(assetElements));
    var cleanupFns = [];
    Array.prototype.forEach.call(allElements, function (el) {
        var contentType = el.getAttribute("data-ctfl-content-type");
        var entry = el.getAttribute("data-ctfl-entry");
        var description = el.getAttribute("data-ctfl-description");
        var asset = el.getAttribute("data-ctfl-asset");
        var params = {
            entryTitle: entryTitle,
            node: el,
            spaceId: spaceId,
        ...
        var cleanup = attach_1.attach(params);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_memoize__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_json_stringify_safe__ = __webpack_require__(176);
...
var init_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = __webpack_require__(2);
var fetch_1 = __webpack_require__(62);
function showPopup(_a) {
    var _this = this;
    var node = _a.node, spaceId = _a.spaceId, contentType = _a.contentType, entry = _a.entry, cleanup = _a.cleanup, asset = _a.asset, entryTitle = _a.entryTitle, description = _a.description, style = _a.style;
    console.log("showing popup...");
    var loadingContent = "\n  <div>\n    " + (description || "") + "\n  </div>\n  loading...";
    var positionStyles = getCoords({ node: node, content: loadingContent });
    var tooltip = utils_1.createElement({
        style: Object.assign({}, style.tooltip, positionStyles),
        text: loadingContent
    });
    var _b = fetch_1.fetchContent({
        spaceId: spaceId,
        contentType: contentType,
        entry: entry,
        asset: asset,
        ...
        description: description,
        style: style
    }), promise = _b.promise, cleanupContent = _b.cleanup;
    promise.then(function (content) {
        console.log(content);
        if (content) {
            tooltip.innerHTML = "";
            var newPositionStyles = getCoords({ node: node, content: content });
            utils_1.applyStyle({
                node: tooltip,
    ...
    var cleanupHover = utils_1.onHover({
        node: tooltip,
        onMouseLeave: function (e) {
            var checkingNode = e.relatedTarget;
            if (!utils_1.containsNode({ node: node, checkingNode: checkingNode })) {
                cleanup();
            }
        }
    });
    return {
        node: tooltip,
        destroy: function () { return __awaiter(_this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, utils_1.animate({
                                node: tooltip,
                                start: 1,
                                stop: 0
                            })];
                    ...
                    case 2:
                        ...
                        console.log("error during removing tooltip::", e_1);
                        return [3 /*break*/, 3];
...
function getCoords(_a) {
    var node = _a.node, content = _a.content;
    var horizontalStyles = positionHorizontally({ node: node });
    var verticalStyles = positionVertically({ node: node, content: content });
    return Object.assign({}, horizontalStyles, verticalStyles);
}
function positionHorizontally(_a) {
    var node = _a.node;
    var _b = node.getBoundingClientRect(), right = _b.right, left = _b.left;
    var offsetX = window.pageXOffset;
    var pageWidth = document.documentElement.clientWidth;
    var rightSpace = pageWidth - right;
    var leftSpace = left;
    var positionStyles = {};
...
function positionVertically(_a) {
    var node = _a.node, content = _a.content;
    var _b = node.getBoundingClientRect(), top = _b.top, height = _b.height;
    var offsetY = window.pageYOffset;
    var pageHeight = document.documentElement.clientHeight;
    var mediumOffset = top + height / 2;
    var maxSpace = Math.min(mediumOffset, pageHeight - mediumOffset) * 2;
    ...
    var contentHeight = utils_1.measureHeight(content) + 30;
    var positionStyles = {};
    if (contentHeight >= pageHeight) {
        ...
        var topOffset = mediumOffset < pageHeight - mediumOffset
            ? offsetY
...
Object.defineProperty(exports, "__esModule", { value: true });
var animate_1 = __webpack_require__(27);
function renderOverlay(_a) {
    var _this = this;
    var node = _a.node, style = _a.style;
    var _b = node.getBoundingClientRect(), bottom = _b.bottom, top = _b.top, left = _b.left, right = _b.right;
    var offsetY = window.pageYOffset;
    var offsetX = window.pageXOffset;
    ...
    return function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, animate_1.animate({
                            node: overlay,
                            start: 0.25,
                            stop: 0
                        })];
                ...
                case 2:
                    e_1 = _a.sent();
                    // tslint:disable-next-line no-console
                    console.log("error during removing overlay::", e_1);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
...
function applyStyle(_a) {
    var node = _a.node, style = _a.style;
    Object.assign(node.style, style);
}
exports.applyStyle = applyStyle;
function createElement(_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.tag, tag = _c === void 0 ? "div" : _c, text = _b.text, style = _b.style, attrs = _b.attrs;
...
function containsNode(_a) {
    var node = _a.node, checkingNode = _a.checkingNode;
    var inspectingNode = checkingNode;
...
Object.defineProperty(exports, "__esModule", { value: true });
function onHover(_a) {
    var node = _a.node, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave;
    node.addEventListener("mouseenter", internalMouseEnter);
    function internalMouseEnter(e) {
        onMouseEnter && onMouseEnter(e);
        node.addEventListener("mouseleave", internalMouseLeave);
    }
    function internalMouseLeave(e) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var appPrefix = "https://app.contentful.com";
function constructSpaceURL(_a) {
    var spaceId = _a.spaceId;
    return appPrefix + "/spaces/" + spaceId;
}
exports.constructSpaceURL = constructSpaceURL;
function constructContentTypeURL(_a) {
    var spaceId = _a.spaceId, contentType = _a.contentType;
    return appPrefix + "/spaces/" + spaceId + "/content_types/" + contentType + "/fields";
}
exports.constructContentTypeURL = constructContentTypeURL;
function constructEntryURL(_a) {
    var spaceId = _a.spaceId, entry = _a.entry;
    return appPrefix + "/spaces/" + spaceId + "/entries/" + entry;
}
exports.constructEntryURL = constructEntryURL;
function constructMediaURL(_a) {
    var spaceId = _a.spaceId;
    return appPrefix + "/spaces/" + spaceId + "/assets";
}
exports.constructMediaURL = constructMediaURL;
function constructAssetURL(_a) {
    var spaceId = _a.spaceId, asset = _a.asset;
    return appPrefix + "/spaces/" + spaceId + "/assets/" + asset;
}
exports.constructAssetURL = constructAssetURL;
function getEntryTitle(_a) {
    var entry = _a.entry, entryTitle = _a.entryTitle;
    var field = getEntryTitleField({ entry: entry, entryTitle: entryTitle });
    var value;
    [field, "title", "name"].filter(Boolean).some(function (property) {
...
function getEntryTitleField(_a) {
    var entry = _a.entry, entryTitle = _a.entryTitle;
...
function mergeStyle(passedStyle) {
    if (passedStyle === void 0) { passedStyle = {}; }
    var newStyle = {};
    newStyle.highlight = Object.assign({}, highlightStyles, passedStyle.highlight);
    newStyle.highlightHover = Object.assign({}, highlightHoverStyles, passedStyle.highlightHover);
...
Object.defineProperty(exports, "__esModule", { value: true });
var fetch_1 = __webpack_require__(63);
var init_1 = __webpack_require__(28);
var utils_1 = __webpack_require__(2);
var utils_2 = __webpack_require__(2);
var renderAssets_1 = __webpack_require__(181);
var renderContentTypes_1 = __webpack_require__(182);
var renderEntriesByCt_1 = __webpack_require__(183);
function fetchContent(_a) {
    var spaceId = _a.spaceId, contentType = _a.contentType, entry = _a.entry, asset = _a.asset, entryTitle = _a.entryTitle, description = _a.description, style = _a.style;
    var closed = false;
    var client = init_1.clients[spaceId];
    var cleanupFns = [];
    var promise = fetch_1.fetch({ client: client, contentType: contentType, entry: entry, asset: asset }).then(function (_a) {
        var contentTypesData = _a.contentTypesData, entriesData = _a.entriesData, assetsData = _a.assetsData;
        console.log(contentTypesData, entriesData, assetsData);
        if (!closed) {
            var container = document.createElement("div");
            var _b = renderContentTypes_1.renderContentTypes({
                contentType: contentType,
                contentTypesData: contentTypesData,
                spaceId: spaceId,
                style: style
            }), ctsContainer = _b.node, ctsCleanup = _b.cleanup;
            var _c = renderEntriesByCt_1.renderEntriesByCt({
                contentType: contentType,
                contentTypesData: contentTypesData,
                ...
                spaceId: spaceId,
                style: style
            }), entriesContainer = _c.node, entriesCleanup = _c.cleanup;
            var _d = renderAssets_1.renderAssets({
                assetsData: assetsData,
                spaceId: spaceId,
                style: style,
                asset: asset
            }), assetsContainer = _d.node, assetsCleanup = _d.cleanup;
            cleanupFns.push(ctsCleanup, entriesCleanup, assetsCleanup);
            var spaceURL = utils_2.constructSpaceURL({ spaceId: spaceId });
            var descriptionNode = utils_1.createElement({
                text: description
            });
            var spaceLink = renderLink({ href: spaceURL, text: "Link to space" });
            container.appendChild(descriptionNode);
            container.appendChild(spaceLink);
            if (contentType) {
                var contentTypeURL = utils_2.constructContentTypeURL({
                    contentType: contentType,
                    spaceId: spaceId
                });
                var ctLink = renderLink({
                    href: contentTypeURL,
            ...
            if (entry) {
                var entryURL = utils_2.constructEntryURL({ spaceId: spaceId, entry: entry });
                var entryLink = renderLink({
                    href: entryURL,
                    text: "Link to entry"
                });
            ...
            if (asset) {
                var assetURL = utils_1.constructAssetURL({ spaceId: spaceId, asset: asset });
                var assetLink = renderLink({
                    href: assetURL,
                    text: "Link to asset"
                });
    ...
    return {
        ...
        cleanup: function () {
            closed = true;
            cleanupFns.forEach(function (fn) { return fn(); });
        }
    };
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var contentTypesData = {};
var entriesData = {};
var assetsData = {};
var contentTypesPromise;
var entriesPromise;
var assetsPromise;
function fetchAssets(_a) {
...
function fetch(_a) {
    var client = _a.client, contentType = _a.contentType, entry = _a.entry, asset = _a.asset;
    ...
    return Promise.all([contentTypesPromise, entriesPromise, assetsPromise])
        ...
        if (contentType) {
            // check content type
            var contentTypeFetchedData = contentTypesData[contentType];
            if (!contentTypeFetchedData) {
                return client.getContentType(contentType).then(function (item) {
                    contentTypesData[item.sys.id] = item;
                });
            }
        }
        ...
        if (entry) {
            // check entry
            var entryFetchedData = entriesData[entry];
            if (!entryFetchedData) {
                return client.getEntry(entry).then(function (item) {
                    entriesData[item.sys.id] = item;
                });
            }
        }
        ...
        .then(function () {
        if (asset) {
            var assetFetchedData = assetsData[asset];
            if (!assetFetchedData) {
                return client.getAsset(asset).then(function (item) {
                    assetsData[item.sys.id] = item;
                });
            }
        }
    })
        .then(function () { return ({ contentTypesData: contentTypesData, entriesData: entriesData, assetsData: assetsData }); });
}
exports.fetch = fetch;
//# sourceMappingURL=fetch.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__contentful_axios__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_contentful_sdk_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__create_contentful_api__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__create_link_resolver__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_qs__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_qs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rate_limit__ = __webpack_require__(163);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isPlainObject__ = __webpack_require__(167);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_os__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_contentful_sdk_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entities__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__paged_sync__ = __webpack_require__(179);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__space__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entry__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__asset__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_type__ = __webpack_require__(178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_cloneDeep__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_contentful_sdk_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_link_getters__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_stringify_safe__ = __webpack_require__(55);
...
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
function renderAssets(_a) {
    var assetsData = _a.assetsData, spaceId = _a.spaceId, style = _a.style, asset = _a.asset;
    var assetsContainer = document.createElement("div");
    var line = utils_1.createElement({
        style: {
            height: "1px",
            margin: "10px 0",
            background: "#ccc"
    ...
    var header = utils_1.createElement({
        tag: "h3",
    ...
    var cleanupFns = [];
    var assetNodes = state_1.getAssetsNodes();
    var filteredAssets = Object.keys(assetNodes).filter(function (assetAtPage) { return assetAtPage !== asset; });
    var assetsOnPage = [asset]
        .concat(filteredAssets)
        .filter(Boolean)
        .map(function (key) { return ({ nodes: assetNodes[key], data: assetsData[key] }); })
        .filter(function (_a) {
        var nodes = _a.nodes;
    ...
    assetsOnPage.forEach(function (_a) {
        var _b = _a.nodes, nodes = _b === void 0 ? [] : _b, data = _a.data;
        var element = document.createElement("div");
        var link = utils_1.constructAssetURL({
            spaceId: spaceId,
            asset: data.sys.id
        });
        var linkNode = utils_1.createElement({
            tag: "a",
            attrs: {
                href: link,
                target: "_blank"
        ...
        var overlays = [];
        var cleanup = utils_1.onHover({
            node: linkNode,
            onMouseEnter: function () {
                nodes.forEach(function (node) {
                    overlays.push(utils_1.renderOverlay({ node: node, style: style.overlay }));
                });
            },
        ...
        function cleanOverlays() {
            overlays.forEach(function (fn) { return fn(); });
            overlays = [];
        }
    });
    return {
...
//# sourceMappingURL=renderAssets.js.map
...
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
function renderContentTypes(_a) {
    var contentTypesData = _a.contentTypesData, spaceId = _a.spaceId, style = _a.style, contentType = _a.contentType;
    var ctsContainer = document.createElement("div");
    var line = utils_1.createElement({
        style: {
            height: "1px",
            margin: "10px 0",
    ...
    var cleanupFns = [];
    var contentTypeNodes = state_1.getContentTypeNodes();
    var filteredCTNodes = Object.keys(contentTypeNodes).filter(function (contentTypeAtPage) { return contentTypeAtPage !== contentType; });
    var ctsOnPage = [contentType]
    ...
    console.log(ctsOnPage);
    ctsOnPage.forEach(function (_a) {
        var _b = _a.nodes, nodes = _b === void 0 ? [] : _b, data = _a.data;
        var element = document.createElement("div");
        var link = utils_1.constructContentTypeURL({
            spaceId: spaceId,
...
//# sourceMappingURL=renderContentTypes.js.map
...
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
var renderEntries_1 = __webpack_require__(184);
function renderEntriesByCt(_a) {
    var contentType = _a.contentType, contentTypesData = _a.contentTypesData, entriesData = _a.entriesData, spaceId = _a.spaceId, entryTitle = _a.entryTitle, style = _a.style;
    var container = utils_1.createElement();
    var cleanupFns = [];
    var filteredCTs = Object.keys(state_1.getContentTypeNodes()).filter(function (contentTypeAtPage) { return contentTypeAtPage !== contentType; });
    [contentType]
        .concat(filteredCTs)
        .filter(Boolean)
        .forEach(function (contentTypeAtPage) {
        var _a = renderEntries_1.renderEntries({
            ...
            entryTitle: entryTitle,
            style: style
        }), node = _a.node, cleanup = _a.cleanup;
...
exports.renderEntriesByCt = renderEntriesByCt;
//# sourceMappingURL=renderEntriesByCt.js.map
...
var state_1 = __webpack_require__(6);
var utils_1 = __webpack_require__(2);
function renderEntries(_a) {
    var contentTypesData = _a.contentTypesData, entriesData = _a.entriesData, spaceId = _a.spaceId, contentType = _a.contentType, entryTitle = _a.entryTitle, style = _a.style;
    var contentTypeData = contentTypesData[contentType];
    var ctsContainer = document.createElement("div");
    var line = utils_1.createElement({
        style: {
            height: "1px",
    ...
    var cleanupFns = [];
    var entries = state_1.getCTEntryNodes({ contentType: contentType });
    var entriesKeys = Object.keys(entries)
        .map(function (entryId) { return ({
        entry: entryId,
    ...
    entriesKeys.forEach(function (_a) {
        var entry = _a.entry, nodes = _a.nodes, data = _a.data;
        var element = document.createElement("div");
        var link = utils_1.constructEntryURL({
            spaceId: spaceId,
            entry: entry
        });
        var linkNode = utils_1.createElement({
            ...
            text: utils_1.getEntryTitle({ entry: data, entryTitle: entryTitle }),
            style: {
                display: "inline-block",
                borderBottom: "1px dashed #ccc",
                textDecoration: "none",
...
//# sourceMappingURL=renderEntries.js.map
